...
##Story - Making a post
In order to make a post the unauthenticated user must first register and then make his post
![loginpage](../Images/Storyboards/making-a-post.png)
*Figure 3* [Making a post](https://joaopedrofump.github.io/lbaw12/index.html)

---
![admin_page](../Images/Storyboards/unfollow-user.png)
*Figure 4* [Unfollow an user](https://joaopedrofump.github.io/lbaw12/admin.html)

---
![feed](../Images/Storyboards/search-website.png)
